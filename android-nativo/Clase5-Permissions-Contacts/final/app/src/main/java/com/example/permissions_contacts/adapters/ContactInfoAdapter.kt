package com.example.permissions_contacts.adapters
...
import com.example.permissions_contacts.R
import com.example.permissions_contacts.databinding.AdapterContactInfoBinding


class ContactInfoAdapter(context: Context, cursor: Cursor?) : CursorAdapter(context, cursor, 0) {
